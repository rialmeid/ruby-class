...
class EventosControllerTest < ActionController::TestCase
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post :create, evento: { inictio: @evento.inictio, local: @evento.local, nome: @evento.nome, termino: @evento.termino }
    end
  ...
  test "should update evento" do
    patch :update, id: @evento, evento: { inictio: @evento.inictio, local: @evento.local, nome: @evento.nome, termino: @evento.termino }
    assert_redirected_to evento_path(assigns(:evento))
  end
